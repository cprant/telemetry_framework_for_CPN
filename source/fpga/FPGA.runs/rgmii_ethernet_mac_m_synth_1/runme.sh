...
HD_PWD='F:/实验室/毕业论文/实验/np123/New_NP_PJ.xpr/New_NP_PJ/New_NP_PJ.runs/rgmii_ethernet_mac_m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgmii_ethernet_mac_m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgmii_ethernet_mac_m.tcl
