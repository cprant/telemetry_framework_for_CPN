...
HD_PWD='F:/实验室/毕业论文/实验/np123/New_NP_PJ.xpr/New_NP_PJ/New_NP_PJ.runs/bd_c84c_xmac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_c84c_xmac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_c84c_xmac_0.tcl
