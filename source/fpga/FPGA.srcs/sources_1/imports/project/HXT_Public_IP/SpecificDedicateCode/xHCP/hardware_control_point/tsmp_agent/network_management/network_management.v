...
wire      [15:0]       wv_rd_state_num_nmp2fifo  ;
wire                   w_rd_state_num_wr_nmp2fifo;
wire                   w_rd_state_num_fifo_empty_fifo2nmg;
wire                   w_rd_state_num_rd_nmg2fifo;
wire      [15:0]       wv_rd_state_num_fifo_rdata_fifo2nmg;
...
.ov_rd_state_num            (wv_rd_state_num_nmp2fifo     ),
.o_rd_state_num_wr          (w_rd_state_num_wr_nmp2fifo   ), 
...
cache_rd_num(              
    ...
    .wrreq                  ( w_rd_state_num_wr_nmp2fifo            ),
    .data                   ( wv_rd_state_num_nmp2fifo              ),
    .rdreq                  ( w_rd_state_num_rd_nmg2fifo            ),
    .q                      ( wv_rd_state_num_fifo_rdata_fifo2nmg   ),
                              
    .usedw                  (                                       ),
    .full                   (                                       ),
    .empty                  ( w_rd_state_num_fifo_empty_fifo2nmg    )
); 

/*
syncfifo_showahead_aclr_w16d16 cache_rd_num(
.data  (wv_rd_state_num_nmp2fifo), 
.wrreq (w_rd_state_num_wr_nmp2fifo),
.rdreq (w_rd_state_num_rd_nmg2fifo),
.clock (i_clk),
...
.i_nmu_fifo_empty                   (w_rd_state_num_fifo_empty_fifo2nmg ),
.o_nmu_fifo_rd                      (w_rd_state_num_rd_nmg2fifo         ),
.iv_nmu_fifo_rdata                  (wv_rd_state_num_fifo_rdata_fifo2nmg),

.iv_ack_fifo_usedw                  (wv_rd_command_ack_fifo_usedw_fifo2npg),  
.o_ack_fifo_rd                      (w_rd_command_ack_rd_npg2fifo         ),      
.iv_ack_fifo_rdata                  (wv_rd_command_ack_rdata_fifo2npg     ),
