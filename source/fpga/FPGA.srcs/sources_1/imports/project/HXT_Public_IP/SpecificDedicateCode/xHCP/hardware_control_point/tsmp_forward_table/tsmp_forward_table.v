...
ParamTdpram_rddly #(
    .ADDR_WIDTH                 ( 12),
    .DATA_WIDTH                 ( 34)
)truedualportram_singleclock_rdenab_outputaclr_w34d4096_inst(      
    .clk                        ( i_clk                 ),
        
    .we_a                       ( w_tsmpforwardram_wr_cpe2ram       ),
    .wdata_a                    ( wv_tsmpforwardram_wdata_cpe2ram   ),
    .addr_a                     ( wv_tsmpforwardram_addr_cpe2ram    ),
    .rdata_a                    ( wv_tsmpforwardram_rdata_ram2cpe   ),
        
    .we_b                       ( 1'd0                  ),
    .wdata_b                    ( 34'd0                 ),
    .addr_b                     ( wv_ram_raddr_b        ),
    .rdata_b                    ( wv_ram_rdata_b        )
);
