...
output reg             o_tan_wr;
output reg [31:0]      ov_tan_wdata;
output reg [18:0]      ov_tan_addr; 
output reg             o_tan_addr_fix;       
output reg             o_tan_rd;
...
always @(posedge i_clk or negedge i_rst_n) begin
    if(i_rst_n == 1'b0)begin
        ...
        if(i_command_wr)begin
            ...
            else if(iv_command[57:51] == 7'd5)begin//tan     
                ov_tan_wdata    <= iv_command[31:0];
                ov_tan_addr     <= iv_command[50:32];
                o_tan_addr_fix  <= iv_command[61];
                if(iv_command[63:62] == 2'b00)begin//write
                    o_tan_wr        <= 1'b1;
                    o_tan_rd        <= 1'b0;      
                end
