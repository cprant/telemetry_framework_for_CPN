...
//--------------------------------------------------------------------------------
//Command: generate_target bd_074d.bd
//Design : bd_074d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_074d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_074d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "SGMII_M_axi_ethernet.hwdef" *) 
module bd_074d
   (clk104_out,
    clk125_out,
    clk208_out,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK104_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK104_OUT, CLK_DOMAIN bd_074d_pcs_pma_0_clk104_out, FREQ_HZ 104166666, INSERT_VIP 0, PHASE 0" *) output clk104_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK125_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK125_OUT, ASSOCIATED_RESET rst_125_out, CLK_DOMAIN bd_074d_pcs_pma_0_clk125_out, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0" *) output clk125_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK208_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK208_OUT, CLK_DOMAIN bd_074d_pcs_pma_0_clk208_out, FREQ_HZ 208333333, INSERT_VIP 0, PHASE 0" *) output clk208_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK625_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK625_OUT, CLK_DOMAIN bd_074d_pcs_pma_0_clk625_out, FREQ_HZ 625000000, INSERT_VIP 0, PHASE 0" *) output clk625_out;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 lvds_clk CLK" *) (* X_INTERFACE_PARAMETER = "ASSOCIATED_BUSIF lvds_clk, CAN_DEBUG false, ASSOCIATED_RESET glbl_rst, FREQ_HZ 125000000" *)input lvds_clk_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 lvds_clk CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME lvds_clk, CAN_DEBUG false, FREQ_HZ 125000000, TYPE ETH_LVDS_CLK" *) input lvds_clk_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 lvds_clk CLK_P" *) input lvds_clk_clk_p;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rx TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rx, CLK_DOMAIN bd_074d_pcs_pma_0_clk125_out, FREQ_HZ 125000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1" *) output [7:0]m_axis_rx_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RX_MAC_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RX_MAC_ACLK, ASSOCIATED_BUSIF m_axis_rx, ASSOCIATED_RESET rx_reset, CLK_DOMAIN bd_074d_pcs_pma_0_clk125_out, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0.000" *) output rx_mac_aclk;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.S_AXI_LITE_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.S_AXI_LITE_CLK, ASSOCIATED_BUSIF s_axi, ASSOCIATED_CLKEN CE, ASSOCIATED_RESET s_axi_lite_resetn, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input s_axi_lite_clk;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_pause TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_pause, CLK_DOMAIN bd_074d_pcs_pma_0_clk125_out, FREQ_HZ 125000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [15:0]s_axis_pause_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_pause TVALID" *) input s_axis_pause_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_tx TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_tx, CLK_DOMAIN bd_074d_pcs_pma_0_clk125_out, FREQ_HZ 125000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1" *) input [7:0]s_axis_tx_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.TX_MAC_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.TX_MAC_ACLK, ASSOCIATED_BUSIF s_axis_pause:s_axis_tx, ASSOCIATED_RESET tx_reset, CLK_DOMAIN bd_074d_pcs_pma_0_clk125_out, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0.000" *) output tx_mac_aclk;
  ...
  wire pcs_pma_mmcm_locked_out_end;
  ...
  assign lvds_clk_1_CLK = lvds_clk_clk;
  ...
  assign pcs_pma_mmcm_locked_out_end = mmcm_locked_out_end;
  ...
  bd_074d_c_counter_binary_0_0 c_counter_binary_0
       (.CLK(s_axi_lite_clk_1),
        .SCLR(util_vector_logic_0_Res),
        .THRESH0(c_counter_binary_0_THRESH0));
  bd_074d_c_shift_ram_0_0 c_shift_ram_0
  ...
  bd_074d_pcs_pma_0 pcs_pma
       (.an_adv_config_val(1'b0),
		...
		.mmcm_locked_out_end       (pcs_pma_mmcm_locked_out_end),
        .phyaddr(xlconstant_phyadd_dout),
        .refclk125(lvds_clk_1_CLK),
        .refclk125_n(lvds_clk_1_CLK_N),
        .refclk125_p(lvds_clk_1_CLK_P),
        .reset(glbl_rst_1),
  ...
  bd_074d_reset_inv_0 reset_inv
       (.Op1(glbl_rst_1),
        .Res(reset_inv_Res));
  bd_074d_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(s_axi_lite_resetn_1),
        .Res(util_vector_logic_0_Res));
  bd_074d_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  bd_074d_xlconstant_config_val_0 xlconstant_config_val
       (.dout(xlconstant_config_val_dout));
  bd_074d_xlconstant_config_vec_0 xlconstant_config_vec
       (.dout(xlconstant_config_vec_dout));
  bd_074d_xlconstant_phyadd_0 xlconstant_phyadd
